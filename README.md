...
- **Windows:** x64, Windows 10 version 2004 or later. Extract the entire ZIP and open `Pinna2HRTF.exe` inside it. [Download the Windows app](https://ecosystem.sonicom.eu/tools/31)
